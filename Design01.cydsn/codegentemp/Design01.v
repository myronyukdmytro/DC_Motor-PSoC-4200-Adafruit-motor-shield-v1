...
module top ;
	...
	wire [0:0] tmpOE__Fix_net;
	wire [0:0] tmpFB_0__Fix_net;
	wire [0:0] tmpIO_0__Fix_net;
	wire [0:0] tmpINTERRUPT_0__Fix_net;
	electrical [0:0] tmpSIOVREF__Fix_net;

	cy_psoc3_pins_v1_10
		#(.id("0a243f87-20dc-4523-bfec-394eaf999f36"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Fix
		 (.oe(tmpOE__Fix_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fix_net[0:0]}),
		  .io({tmpIO_0__Fix_net[0:0]}),
		  .siovref(tmpSIOVREF__Fix_net),
		  .interrupt({tmpINTERRUPT_0__Fix_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fix_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("34530cd5-7e25-4fbf-9bb2-a85fae1619b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c3a41665-3823-424d-90b5-8fc540be8509"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d2bacfab-4211-44d5-9c07-180b673585c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a5b99d9e-dc2d-494e-9c89-665eba6a8566"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fe497157-e942-47cf-9557-52b7d9541524"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__pwm4_net;
	wire [0:0] tmpFB_0__pwm4_net;
	wire [0:0] tmpIO_0__pwm4_net;
	wire [0:0] tmpINTERRUPT_0__pwm4_net;
	electrical [0:0] tmpSIOVREF__pwm4_net;

	cy_psoc3_pins_v1_10
		#(.id("c15771a3-58ac-4597-beea-8fad0a0d2e99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		pwm4
		 (.oe(tmpOE__pwm4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pwm4_net[0:0]}),
		  .io({tmpIO_0__pwm4_net[0:0]}),
		  .siovref(tmpSIOVREF__pwm4_net),
		  .interrupt({tmpINTERRUPT_0__pwm4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pwm4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
